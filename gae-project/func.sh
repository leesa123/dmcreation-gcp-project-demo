...
sed -i -- "s/\[ENVIRONMENT\]/$_ENVIRONMENT/g" ./appengine-v1/gae-template.yaml
sed -i -- "s/\[SCRIPTPATH\]/$_SCRIPTPATH/g" ./appengine-v1/gae-template.yaml
sed -i -- "s/\[SECURITYLEVEL\]/$_SECURITYLEVEL/g" ./appengine-v1/gae-template.yaml
sed -i -- "s/\[URLREGEX\]/$_URLREGEX/g" ./appengine-v1/gae-template.yaml
sed -i -- "s/\[FILEINFO\]/$_FILEINFO/g" ./appengine-v1/gae-template.yaml
